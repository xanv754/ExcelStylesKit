...
class ExcelStyle:
    ...
    def set_background(self, hex_color: str) -> bool:
        ...
        try:
            ...
            self._excel.apply_style(property="fill", value=fill)
    ...
    def set_font(
        ...
        try:
            ...
            self._excel.apply_style(property="font", value=font)
        except Exception as error:
            print("ExcelStyle Error", error)
            return False
        else:
    ...
    def set_alignment(
        ...
        try:
            ...
            self._excel.apply_style(property="alignment", value=alignment)
        except Exception as error:
            print("ExcelStyle Error", error)
            return False
        else:
    ...
    def set_border(
        ...
        try:
            ...
            self._excel.apply_style(property="border", value=border)
        except Exception as error:
            print("ExcelStyle Error", error)
            return False
        else:
